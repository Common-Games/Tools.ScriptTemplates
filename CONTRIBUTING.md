...
1. Make an [Issue](https://github.com/common-games/tools.customizable-script-templates/issues/new)
...
```json
    {
        "dependencies": {
            "com.common-games.tools.customizable-script-templates": "https://github.com/YOUR_USER/tools.customizable-script-templates.git"
        }
    }
```
